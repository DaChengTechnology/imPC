...
namespace ChangLiao.DIYListBox.ScrollBar
{
    class ChatListScrollBar
    {
        //滚动条自身的区域
        ...
        public ChatListScrollBar(Control c)
        {
            this.ctrl = c;
            virtualHeight = 400;
            ...
            this.backColor = Color.FromArgb(64, 89, 99, 168);
            this.sliderDefaultColor = Color.FromArgb(128, 89, 99, 168);
            this.sliderDownColor = Color.FromArgb(128, 89, 99, 168);
            this.arrowBackColor = Color.FromArgb(64, 89, 99, 168);
            this.arrowColor = Color.FromArgb(128, 89, 99, 168);
        }
