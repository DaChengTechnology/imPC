...
namespace ChangLiao.ChildView
{
    ...
    /// 圆形进度条
    /// </summary>
    public class GDProgressBar : DuiBaseControl
    {
        ...
        private Color topColor = Color.FromArgb(117, 255, 146);
        ...
        private void DrawShape(Graphics g)
        {
            ...
            //4、绘制进度显示值
            if (this.progress == maxValue && allowComplete)
            {
                //绘制完成标志
